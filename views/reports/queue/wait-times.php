...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-0"><?= $this->__('reports.wait_times') ?></h1>
        <p class="text-muted mb-0"><?= $this->__('reports.wait_times_subtitle') ?></p>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card mb-4">
            <div class="card-header"><?= $this->__('reports.wait_distribution') ?></div>
            <div class="card-body">
                ...
                <table class="table table-sm">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><?= $this->__('reports.calls') ?></th>
                            <th><?= $this->__('reports.percentage') ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        <tr>
                            <td colspan="3" class="text-center text-muted"><?= $this->__('common.no_data') ?></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<div class="card">
    <div class="card-header"><?= $this->__('reports.wait_times') ?></div>
    <div class="card-body">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="text-center"><?= $this->__('reports.min_wait') ?></th>
                        <th class="text-center"><?= $this->__('reports.max_wait') ?></th>
                ...
                <tbody>
                    ...
                    <?php if (empty($queues)): ?>
                    <tr>
                        <td colspan="5" class="text-center text-muted py-4"><?= $this->__('reports.no_data_period') ?></td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
