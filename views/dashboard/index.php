...
<div class="row mb-4">
    <div class="col-md-3">
        <div class="stat-card primary">
            ...
            <div class="stat-label"><?= $this->__('dashboard.total_calls') ?> <button class="metric-help" onclick="$(this).closest('.stat-card').find('.metric-desc').toggleClass('show')">?</button></div>
    ...
    <div class="col-md-3">
        <div class="stat-card success">
            ...
            <div class="stat-label"><?= $this->__('dashboard.answered') ?> <button class="metric-help" onclick="$(this).closest('.stat-card').find('.metric-desc').toggleClass('show')">?</button></div>
            <div class="stat-change">
    ...
    <div class="col-md-3">
        <div class="stat-card warning">
            ...
            <div class="stat-label"><?= $this->__('dashboard.abandoned') ?> <button class="metric-help" onclick="$(this).closest('.stat-card').find('.metric-desc').toggleClass('show')">?</button></div>
            <div class="stat-change">
    ...
    <div class="col-md-3">
        <div class="stat-card info">
            ...
            <div class="stat-label"><?= $this->__('dashboard.avg_talk') ?> <button class="metric-help" onclick="$(this).closest('.stat-card').find('.metric-desc').toggleClass('show')">?</button></div>
            <div class="stat-change">
